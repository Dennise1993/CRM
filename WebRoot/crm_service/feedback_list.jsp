...
<script type="text/javascript">
	function gain() {
		...
		window.location.href = "vagueByFeed?name=" + name + "&service="
				+ service + "&date=" + date;

	}
	function to(tem){
	
	window.location.href ="feedBake?updat="+tem;
	}
...
<body>
	<div style="padding:5px;">
		...
		<a href="javascript:toPage(1)" title="查询">查询</a>
		 ...
		 <s:form action="feedService.action">
				...
				<tbody>
					<s:iterator value="recordList" status="p">
						<tr>
							...
							<td><img title="处理" src="images/gear.ico"
								class="op_button" onclick="to('<s:property value="svrId" />')" /></td>
						</tr>
					</s:iterator>
