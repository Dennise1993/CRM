...
<body>
	<div style="padding:5px;">
		...
		<div class="operation_button">
		 ...
		 <s:form action="filing.action">
		<div class="search_input">
			<ul class="txt">
			
				<li>客户名称：<s:textfield name="vague.name"/></li>
				<li>服务类型：
				...
				<tbody>
					<s:iterator value="recordList" status="p">
						<tr>
							...
							<td>已处理</td>
							<td><img title="明细" src="images/document.ico"
								class="op_button" onclick="to('fileOne?updat=<s:property value="svrId" />')" />
							</td>
						</tr>
					</s:iterator>
				</tbody>
