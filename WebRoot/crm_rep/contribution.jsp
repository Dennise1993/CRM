...
<div style="padding:5px;">
  ...
  <s:form action="contri_show">
  <div class="search_input">
    <ul class="txt">
      <li>客户名称：
        <s:textfield name="searchParams.custName"/>       
      </li>
      <li>年份：
        <s:select name="searchParams.year"  list="#{2012:'2012', 2013:'2013',2014:'2014',2015:'2015',2016:'2016'}" headerKey="" headerValue="不限">        
        </s:select>
      </li>
    </ul>
  </div>
