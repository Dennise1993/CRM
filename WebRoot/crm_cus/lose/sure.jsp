...
<script type="text/javascript">
   //保存路径
   function saveon(){
    var tee=document.getElementById("tom").value;
    if(tee!=null&& tee!=""){
    
     window.location.href="ScstUpdateLo?cstLost.lstId=<s:property value='cstLost.lstId'/>&cstLost.lstReason="+tee;
    }else{
        alert("流失原因不能为空！！！！");
    }
   }
...
<div style="padding:5px;">
  <div class="txt" style="padding-top:3px;" >当前位置：客户开发计划&nbsp;&gt;&nbsp;客户流失管理&nbsp;&gt;&nbsp;<a href="list.jsp">流失信息</a>&nbsp;&gt;&nbsp;确认流失
    <hr class="hr1" />
  </div>
  <div class="operation_button">
  	<a href="#" title="返回" onclick="back()">返回</a>
    <a href="#" title="暂缓流失" onclick="hoho('ScstRespite','<s:property value="lstId" />')">暂缓流失</a>
    ...
    <div class="in_bg">
      <table border="0" cellpadding="0" cellspacing="0" class="table_input txt">
        ...
        <tr>
          ...
          <td><textarea id="tom" rows="6" cols="36" ></textarea></td>
          <td></td>
          <td></td>
        </tr>
      </table>
